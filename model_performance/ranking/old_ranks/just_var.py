...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 12:44:29 2026
    ...
    for variable in variables:
        for season in seasons:
            ...
            for model in models:
                ...
                storage_dict[model][variable][season] = int(np.sum(var_val))
...
save_data = rank_data(data, 'just_var.txt', '/uufs/chpc.utah.edu/common/home/strong-group7/sydney/GSLBIP/model_performance/ranking/', save = True)
...
grand_total = rank_calcs('just_var.txt', '/uufs/chpc.utah.edu/common/home/strong-group7/sydney/GSLBIP/model_performance/ranking/')
pr = rank_calcs('just_var.txt', '/uufs/chpc.utah.edu/common/home/strong-group7/sydney/GSLBIP/model_performance/ranking/', variable = 'pr')
tasmin = rank_calcs('just_var.txt', '/uufs/chpc.utah.edu/common/home/strong-group7/sydney/GSLBIP/model_performance/ranking/', variable = 'tasmin')
tasmax = rank_calcs('just_var.txt', '/uufs/chpc.utah.edu/common/home/strong-group7/sydney/GSLBIP/model_performance/ranking/', variable = 'tasmax')
