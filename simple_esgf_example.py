...
# vars_to_intake = ['huss','tasmax','tasmin','rsds','pr','uas','vas']
# vars_to_intake = ['pr','tas']
# variables_to_check = ['tas', 'huss', 'ps', 'psl', 'vas', 'uas', 'ts', 'mrsos', 'tsl','hus', 'ta', 'va', 'ua', 'zg', 'mrsol']
variables_to_check  = ['tos']

#'zg', 'psl'
# ssps = ['historical', 'ssp119', 'ssp126', 'ssp245', 'ssp434', 'ssp370', 'ssp534-over','ssp585']

# xu18_ssp = ['historical','ssp245','ssp585']
# xu18_models = ['ACCESS-CM2','ACCESS-ESM1-5','AWI-CM-1-1-MR','BCC-CSM2-MR','CanESM5','CESM2','CESM2-WACCM','EC-Earth3','EC-Earth3-Veg',
  #              'FGOALS-f3-L','FGOALS-g3','GFDL-ESM4','IPSL-CM6A-LR','MIROC6','MPI-ESM1-2-HR',
    #            'MPI-ESM1-2-LR','MRI-ESM2-0','NorESM2-LM']
# xu18_vars = ['tas','pr']
# xu18_table_id = 'Amon'
# xu18_models = 'NorESM2-LM'
ssp = 'ssp585'
cat=cat.search(
    source_id='CanESM5',
